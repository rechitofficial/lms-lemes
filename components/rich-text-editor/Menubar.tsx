                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle
                                ...
                                className={cn(
                                    editor.isActive("textAlign", { align: "left" }) && "bg-muted text-muted-foreground",
                                )}>
                                <AlignLeft />
                            </Toggle>
                        </TooltipTrigger>
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle
                                ...
                                className={cn(
                                    editor.isActive("textAlign", { align: "center" }) && "bg-muted text-muted-foreground",
                                )}>
                                <AlignCenter />
                            </Toggle>
                        </TooltipTrigger>
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle
                                ...
                                className={cn(
                                    editor.isActive("textAlign", { align: "right" }) && "bg-muted text-muted-foreground",
                                )}>
                                <AlignRight />
                            </Toggle>
                        </TooltipTrigger>
